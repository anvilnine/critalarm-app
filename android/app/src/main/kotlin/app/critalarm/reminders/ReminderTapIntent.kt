...
object ReminderTapIntent {
    ...
    fun open(context: Context, spec: ReminderSpec, action: String, requestCode: Int): PendingIntent {
        val intent = Intent(context, MainActivity::class.java).apply {
            ...
            putExtra(ReminderAlarms.EXTRA_ID, spec.id)
    ...
    fun inBackground(context: Context, spec: ReminderSpec, action: String, requestCode: Int): PendingIntent {
    ...
    fun read(context: Context, intent: Intent?): Map<String, Any>? {
        ...
        intent.removeExtra(ReminderAlarms.EXTRA_ID)
