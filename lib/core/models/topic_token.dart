...
/// with ids and dates only (api.md §3.1). A value is shown once, when the
/// token is made, and never again.
@immutable
final class TopicTokenInfo {
  const TopicTokenInfo({required this.tokenId, this.createdAt});
  ...
  @override
  int get hashCode => Object.hash(tokenId, createdAt);
}
