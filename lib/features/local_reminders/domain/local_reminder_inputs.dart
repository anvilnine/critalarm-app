...
@immutable
final class LocalReminderTopic {
  const LocalReminderTopic({
    required this.name,
...
@immutable
final class LocalReminderIncident {
  const LocalReminderIncident({
    required this.id,
    required this.topic,
    this.isTest = false,
...
@immutable
final class LocalReminderInputs {
  const LocalReminderInputs({
    required this.now,
  ...
  final List<LocalReminderTopic> topics;
  final List<LocalReminderIncident> incidents;
  ...
  final Set<String> planHeadsUpsSent;
