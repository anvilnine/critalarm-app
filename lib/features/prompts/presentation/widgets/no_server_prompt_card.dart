...
/// Critical blocker banner displayed on the home page when onboarding server
/// configuration was skipped or no server is connected.
class NoServerPromptCard extends StatelessWidget {
  const NoServerPromptCard({super.key});
