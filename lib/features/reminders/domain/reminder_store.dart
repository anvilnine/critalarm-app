...
abstract interface class ReminderStore {
  ...
  ReminderSwitches readSwitches();
  Future<void> writeSwitches(ReminderSwitches switches);
  ...
  Set<String> readPlanNoticesSent();
  Future<void> addPlanNoticeSent(String key);
