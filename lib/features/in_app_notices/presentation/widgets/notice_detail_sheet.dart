...
/// Opens the explainer behind a pinned notice: the same face, title and
/// sentence the notice is short for, plus the thing it is asking for.
///
/// [onAction] runs after the sheet has closed. [onDismiss] runs when the user
/// takes the way out instead, so the caller can put the notice to sleep.
Future<void> showNoticeDetailSheet({
  ...
  return showAppSheet<void>(
    context: context,
    content: (sheetContext) => NoticeDetailSheet(
      face: face,
      title: title,
      body: body,
...
/// What [showNoticeDetailSheet] puts inside the sheet. The callbacks already
