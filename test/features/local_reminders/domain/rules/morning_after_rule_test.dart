...
void main() {
  ...
  LocalReminderInputs inputs(
    List<LocalReminderIncident> incidents, {
  ...
  test('plans 09:00 after a real night ring that was acked', () {
    ...
    expect(c.id, LocalReminderIds.morningAfter);
    expect(c.fireAt, DateTime(2026, 9, 23, 9));
    expect(c.args[LocalReminderArgs.time], '03:12');
    expect(c.args[LocalReminderArgs.topic], 'db-2');
    expect(c.args[LocalReminderArgs.seconds], '48');
